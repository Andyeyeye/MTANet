...
class SEModule(nn.Module):
    ...
    def __init__(self, planes, compress_rate):
        ...
        self.conv1 = nn.Conv2d(planes, planes // compress_rate, kernel_size=1, stride=1, padding=0, bias=True)
        self.conv2 = nn.Conv2d(planes // compress_rate, planes, kernel_size=1, stride=1, padding=0, bias=True)
